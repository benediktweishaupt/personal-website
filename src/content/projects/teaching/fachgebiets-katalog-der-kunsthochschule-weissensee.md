...
meta:
  ...
  copy: "Semester Project with Matthias Hübner, Prof. Barbara Junge, Prof. Wim Westerveld, and Silvan Händler. Kunsthochschule Weißensee"
...
The basic idea behind the catalog was to be assisted as much as possible by technology. At the center of this is the keywording of the project images by a neural network, which can be found in the index on the cover of the catalog.
