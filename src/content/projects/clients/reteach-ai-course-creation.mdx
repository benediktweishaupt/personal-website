...
order: 7
cover:
  image: ../../../assets/projects/reteach/ai-course/cover.png
...
meta:
  ...
  team: "5 people (Design, AI Engineers, PM, CS)"
  institution: Reteach
  year: "2025–2024"
  ongoing: true
  copy: For Reteach as Product Designer, designing an AI-assisted course builder with a cross-functional team
cvHidden: true
...
<ProjectSection variant="centered" gap="7">
  <ProjectTextBlock>
    ...
    Because Reteach had no analytics framework, we had no quantitative way to measure adoption at scale. But the signal from ICP-near customers was clear — and unexpected. Instead of generating courses from scratch, they used the feature to edit existing texts for equal length across lessons, to rewrite complex material into plain language ("einfache Sprache"), and to fill the last 50% of courses that had stalled mid-production. The tool found its use case not where we designed it, but where authors had the most friction.
