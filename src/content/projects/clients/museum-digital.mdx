...
<ProjectSection variant="full" gap="10">
  <ProjectDescription>
    How a regional museum with entirely analogue infrastructure launched a
    digital platform for its everyday-object collection — on time, on budget,
    passing GDPR and accessibility audits, and leaving staff fully independent
    of outside help.
  </ProjectDescription>
...
<ProjectSection variant="simple" gap="2">
  ...
  <ProjectTagList
    tags={["Digital Consultant", "UX Design", "Technical Architecture"]}
  />
</ProjectSection>
...
<ProjectMediaGrid
  ...
  items={[
    {
      type: "video",
      src: "/video/projects/museum-digital/platform-walkthrough.mp4",
      alt: "Platform walkthrough showing collection browsing and object interaction.",
      caption:
  ...
  items={[
    {
      type: "image",
      src: landingPage,
      alt: "Landing page with inline object thumbnails, federal funding logos, and a split call-to-action.",
      caption:
        'Landing page with inline object thumbnails, federal funding logos (Kulturstiftung des Bundes, dive_in), and a split call-to-action: "Wie funktioniert\'s?" for first-time visitors, "Los geht\'s" for returning contributors.',
    },
  ]}
/>
...
<ProjectMediaGrid
  ...
  items={[
    {
      type: "image",
      src: objectDetailMobile,
      alt: "Object detail on mobile showing a Plaste-Trinkflasche with contributor icons.",
      caption:
        'Object detail on mobile: "Plaste-Trinkflasche" with contributor icons and a second object below. The vertical scroll rhythm on small screens.',
    },
  ]}
/> 
*/}
  ...
  items={[
    {
      type: "image",
      src: themenweltReise,
      alt: "Themenwelt Reise — thematic entry point with editorial context about GDR travel restrictions.",
      caption:
    ...
    {
      type: "image",
      src: contributorReflection,
      alt: "A personal reflection by a contributor about growing up with songs on car trips.",
      caption:
...
<ProjectMediaGrid
  ...
  items={[
    {
      type: "image",
      src: backendReviewFlow,
      alt: "Backend review flow: post submission, museum team review, approve or request changes.",
      caption:
...
<ProjectSection variant="centered" gap="7">
  ...
  items={[
    {
      type: "image",
      src: frontendContributorFlow,
      alt: "Frontend contributor flow from sign up through object selection to submission.",
      caption:
  ...
  items={[
    {
      type: "image",
      src: wireflow,
      alt: "Detailed wireflow of the contributor posting flow with empty, filled, and error states.",
      caption:
...
<ProjectMediaGrid
  ...
  items={[
    {
      type: "video",
      src: "/video/projects/museum-digital/early-prototype.mp4",
      alt: "Early platform recording showing a different interaction state during development.",
      caption:
...
<ProjectMediaGrid
  ...
  items={[
    {
      type: "video",
      src: "/video/projects/museum-digital/stern-radio-camping.mp4",
      alt: "Stern Radio Camping — frame-by-frame documentation of everyday GDR objects",
      caption:
...
<ProjectSection variant="centered" gap="7">
  <ProjectTextBlock>
    Digitising a museum collection under public-funding constraints demanded
    discipline more than innovation. Progress was measured not by features but
    by stability. The project succeeded because it aligned design decisions with
    administrative structure — turning requirements into framework instead of
    friction. The museum publishes independently now. The system runs on their
    own servers, maintained by their own staff.
  </ProjectTextBlock>
</ProjectSection>
